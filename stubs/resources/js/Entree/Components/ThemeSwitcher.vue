...
<template>
    <div class="flex-initial mr-4">
        <button id="theme-toggle" type="button"
                @click="themeDark"
                class="px-2 my-auto text-green-900 hover:bg-gray-50 dark:text-white dark:bg-gray-900 dark:hover:bg-gray-700 focus:outline-none rounded-full text-sm py-2">
